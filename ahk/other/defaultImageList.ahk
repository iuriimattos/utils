...
Gui, Add, ListView, h400 w180, Icon & Number|Description  ; Create a ListView.
...
Loop 326  ; Load the ImageList with a series of icons from the DLL.
    IL_Add(ImageListID, "shell32.dll", A_Index) 
Loop 326  ; Add rows to the ListView (for demonstration purposes, one for each icon).
