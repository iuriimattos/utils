...
strs := ["phonehouse", "yangchengpuyi", "toktok", "crossasia", "shhzzcy", "smartphonenice", "blingshop", "oasismall", "okshop", "bestdeal", "smartphone", "smartphone"]

Loop , % strs.count()
   sendURI(EncodeDecodeURI(strs[A_Index]))
